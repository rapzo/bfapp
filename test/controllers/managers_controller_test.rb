...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { active: @manager.active, email: @manager.email, locked: @manager.locked, name: @manager.name, password_hash: @manager.password_hash, password_salt: @manager.password_salt }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { active: @manager.active, email: @manager.email, locked: @manager.locked, name: @manager.name, password_hash: @manager.password_hash, password_salt: @manager.password_salt }
    assert_redirected_to manager_path(assigns(:manager))
  end
